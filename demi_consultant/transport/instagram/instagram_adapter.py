            ...
            for message in messages:
                try:
                    ...
                    if message.text is not None and message.text.strip():
                        ...
                        image_bytes, mime_type = await self._instagram_client.download_media_url(message.media_url)
                        ...
                        image_bytes, mime_type = await self._instagram_client.download_media(message.media_id)
                        reply = await self.handle_image(
                            message.user_id,
                            image_bytes,
                            caption=message.caption,
